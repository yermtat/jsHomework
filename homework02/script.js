...
//   summNum =
//     this.numenator * parseInt(commonDunemanator / this.denominator) +
//     frac2.numenator * parseInt(commonDunemanator / frac2.denominator);
...
//   return new Fraction(
//     this.numenator * frac2.numenator,
...
//   return new Fraction(
//     this.numenator * frac2.denomenator,
//     this.denominator * frac2.numinator
//   );
// };

// Fraction.prototype.decrease = function () {
//   let y = this.numenator;
//   let x = this.denominator;
//   while (x != y) {
//     if (x > y) {
//       x = x - y;
//     } else {
...
//   return new Fraction(this.numenator / y, this.denominator / y);
// };

// let fracc1 = new Fraction(2, 5);
// let fracc2 = new Fraction(5, 10);

// let fr = fracc2.decrease();
